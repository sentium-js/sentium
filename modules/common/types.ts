 ...
 */
export type Class<Args extends readonly any[] = any[], Return extends any = any> = new (
  ...args: Args
) => Return;
 ...
 */
export type Method<Args extends readonly any[] = any[], Return extends any = any> = (
  ...args: Args
) => Return;
...
export type InstanceTypes<Classes extends readonly Class[]> = {
  readonly [Index in keyof Classes]: Classes[Index] extends Class<infer _, infer Return>
    ? Return
    : never;
};
