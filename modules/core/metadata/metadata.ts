...
export class Metadata<M, T extends object> {
  ...
  private get record(): Record<PropertyKey, M> {
    let meta = Object.getOwnPropertyDescriptor(this.target, METADATA_KEY)
      ?.value;

    if (!meta) {
      meta = {};
      Object.defineProperty(this.target, METADATA_KEY, {
        value: meta,
        enumerable: false,
      });
    }
  ...
  static get<M, T extends object = object>(
    ...
    return new Metadata<M | undefined, T>(target, key, undefined, { scope })
      .value;
  }
